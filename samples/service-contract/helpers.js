...
function getServiceContract(cloudHost, account, company, activity_id) {
  ...
  return new Promise(resolve => {
   ...
   const personQuery= "query:SELECT DISTINCT u.id FROM UnifiedPerson u JOIN Region r ON r.id IN u.regions JOIN Activity a ON r.externalId=a.udf.ZActivityRegion WHERE a.id=";
